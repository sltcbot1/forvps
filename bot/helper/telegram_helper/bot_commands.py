...
class _BotCommands:
    def __init__(self):
        ...
        self.MirrorCommand = f'mir2{CMD_INDEX}'
        self.UnzipMirrorCommand = f'unzipmir2{CMD_INDEX}'
        self.ZipMirrorCommand = f'zipmir2{CMD_INDEX}'
        ...
        self.QbMirrorCommand = f'qbmir2{CMD_INDEX}'
        self.QbUnzipMirrorCommand = f'qbunzipmir2{CMD_INDEX}'
        self.QbZipMirrorCommand = f'qbzipmir2{CMD_INDEX}'
